...
import { getUserProfileThunk, getStatusThunk, updateStatus, savePhoto} from '../redux/profile-reducer'
...
export default compose(
  connect(mapStateToProps, {getUserProfileThunk, getStatusThunk, updateStatus, savePhoto}),
  withRouter,
  // WithAuthRedirect
)(ProfileContainer)